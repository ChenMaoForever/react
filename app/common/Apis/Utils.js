...
import {Toast,alert} from 'antd-mobile';
    ...
    if(data == null || data.length == 0) {
        ...
        for(var i = 0; i < files.length; i++) {
            ...
            getAllHash(files[i],function(HashData){
                ...
                $.ajax({
                    type: "post",
                    url: "https://uu.uns1066.com/myh-admin/file/insertFileUrl",
...
function generateHash(fileData,successCallback,failCallback){
    $.ajax({
        type: "post",
        url: "https://uu.uns1066.com/upload",
        async: true,
        data: fileData,
        processData:false,
        contentType:false,
...
export const setPageTitle=(title)=>{
    ...
    iframe.setAttribute("src", constants.shareShopImgUrl);
